...
<div class="max-w-2xl mx-auto p-4">
	...
	<!-- Support Section -->
	<h2 class="text-lg font-semibold mt-8 mb-4 text-gray-700">Support</h2>
	<div class="bg-white rounded-lg shadow divide-y">
		<!-- Send Feedback -->
		<a href="/settings/feedback" class="block p-4 hover:bg-gray-50 transition-colors">
			<div class="flex items-center justify-between">
				<div class="flex items-center gap-3">
					...
					<div>
						...
						<p class="text-sm text-gray-500">Report a bug or suggest a feature</p>
					</div>
				</div>
				<svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
